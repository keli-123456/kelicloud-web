...
export const STATIC_EC2_INSTANCE_TYPE_PRESETS: BuiltinPlanOption[] = [
  { value: "t3.micro", label: "t3.micro", hint: "2 vCPU / 1 GB / x86" },
  { value: "t3.small", label: "t3.small", hint: "2 vCPU / 2 GB / x86" },
  { value: "t3.medium", label: "t3.medium", hint: "2 vCPU / 4 GB / x86" },
  { value: "m8i.large", label: "m8i.large", hint: "2 vCPU / 8 GB / x86" },
  { value: "c8i.large", label: "c8i.large", hint: "2 vCPU / 4 GB / x86" },
  { value: "r8i.large", label: "r8i.large", hint: "2 vCPU / 16 GB / x86" },
  { value: "m7i.large", label: "m7i.large", hint: "2 vCPU / 8 GB / x86" },
  { value: "c7i.large", label: "c7i.large", hint: "2 vCPU / 4 GB / x86" },
  { value: "r7i.large", label: "r7i.large", hint: "2 vCPU / 16 GB / x86" },
  { value: "t4g.micro", label: "t4g.micro", hint: "2 vCPU / 1 GB / ARM64" },
  { value: "t4g.small", label: "t4g.small", hint: "2 vCPU / 2 GB / ARM64" },
  { value: "t4g.medium", label: "t4g.medium", hint: "2 vCPU / 4 GB / ARM64" },
  { value: "m8g.large", label: "m8g.large", hint: "2 vCPU / 8 GB / ARM64" },
  { value: "c8g.large", label: "c8g.large", hint: "2 vCPU / 4 GB / ARM64" },
  { value: "r8g.large", label: "r8g.large", hint: "2 vCPU / 16 GB / ARM64" },
  { value: "m7g.large", label: "m7g.large", hint: "2 vCPU / 8 GB / ARM64" },
  { value: "c7g.large", label: "c7g.large", hint: "2 vCPU / 4 GB / ARM64" },
  { value: "r7g.large", label: "r7g.large", hint: "2 vCPU / 16 GB / ARM64" },
];
...
export const COMMON_AZURE_SIZES: BuiltinPlanOption[] = [
  ...
  { value: "Standard_F2s_v2", label: "F2s v2", hint: "2 vCPU / 4 GB" },
  { value: "Standard_F4s_v2", label: "F4s v2", hint: "4 vCPU / 8 GB" },
  { value: "Standard_F8s_v2", label: "F8s v2", hint: "8 vCPU / 16 GB" },
  { value: "Standard_F16s_v2", label: "F16s v2", hint: "16 vCPU / 32 GB" },
  { value: "Standard_F32s_v2", label: "F32s v2", hint: "32 vCPU / 64 GB" },
