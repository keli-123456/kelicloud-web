...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[12px] font-semibold leading-4 tracking-normal whitespace-nowrap [&_svg]:size-3.5",
  {
    variants: {
      variant: {
        ...
        info: "border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-200",
      },
    },
    defaultVariants: {
      variant: "default",
