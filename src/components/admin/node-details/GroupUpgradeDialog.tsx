        ...
        {combinedOutput ? (
          <div className="mt-4">
            ...
            <TextArea
              ...
              className="min-h-44 rounded-lg border-slate-200 bg-slate-50/90 font-mono text-xs text-slate-700 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200"
            />
          </div>
        ) : null}
