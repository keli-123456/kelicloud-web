const ADMIN_FORM_DIALOG_CLASS =
  "admin-dialog flex max-h-[min(90vh,calc(100dvh-1.5rem))] w-[calc(100vw-1rem)] max-w-[52rem] flex-col overflow-hidden sm:w-[calc(100vw-2rem)] sm:max-w-[52rem]";

const ADMIN_FORM_DIALOG_WIDE_CLASS =
  "admin-dialog flex max-h-[min(92vh,calc(100dvh-1.5rem))] w-[calc(100vw-1rem)] max-w-[72rem] flex-col overflow-hidden sm:w-[calc(100vw-2rem)] sm:max-w-[72rem]";
...
const ADMIN_FORM_BODY_CLASS =
  "admin-form-scroll min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain px-4 py-4 sm:px-5 [scrollbar-gutter:stable]";
...
const ADMIN_FORM_SECTION_CLASS =
  "border-t border-border/70 pt-3.5 first:border-t-0 first:pt-0";

const ADMIN_FORM_SECTION_COMPACT_CLASS =
  "border-t border-border/70 pt-2.5 first:border-t-0 first:pt-0";
